...
<body>
  ...
  <%
	...
	editstudroll=Integer.parseInt(request.getParameter("editstudroll"));
    ...
    s=obj.getstudent(editstudroll);
    application.setAttribute("editroll", editstudroll);%>
        ...
        <div class="row">
            ...
            <div class="col l4 m6 s12">
                <div class="card center">
                    <h3 class="orange-text">Edit Student</h3>
                    <form
                        onsubmit="return studentregistervalidate('rollno','msg1','sname','msg2','physics','msg3','chemistry','msg4','maths')"
                        action="Editstudent" method="post">
                        <div class="input-field">
                            <i class="material-icons-outlined prefix">library_books</i>
                            <label for="rollno">Roll No</label>
                            <input id="rollno" name="" disabled="disabled" type="number"
                                onfocusout="rollnovalidation('rollno', 'msg1')" value="<%=s.getRollno()%>">
                            <p id="msg1" class="msg"></p>
                        </div>
                        <div class="input-field">
                            <i class="material-icons-outlined prefix">account_circle</i>
                            <label for="sname">Name</label>
                            <input id="sname" name="sname" type="text" onfocusout="namevalidation('sname', 'msg2')" value="<%=s.getName()%>" />
                        ...
                        <div class="input-field">
                            ...
                            <input id="physics" name="physics" type="number"
                                onfocusout="marksvalidation('physics', 'msg3')" value="<%=s.getPhysics()%>">
                        ...
                        <div class="input-field">
                            ...
                            <input id="chemistry" name="chemistry" type="number"
                                onfocusout="marksvalidation('chemistry', 'msg4')" value="<%=s.getChemistry()%>">
                        ...
                        <div class="input-field">
                            ...
                            <input id="maths" name="maths" type="number"
                                onfocusout="marksvalidation('maths', 'msg5')" value="<%=s.getMaths()%>">
